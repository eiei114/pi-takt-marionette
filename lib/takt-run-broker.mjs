...
function startPty(message) {
  ...
  terminal = new Terminal({
    ...
    // Same reason as createTaktScreenTerminal in takt-run-controller.ts:
    // stray PTY control bytes (e.g. DEL) would otherwise dump
    // `xterm.js: Parsing error: ...` state through console.error.
    logLevel: "off",
  });
